...
function rewriteLiveReferences(programPath, metadata) {
  ...
  (0, _babelHelperSimpleAccess.default)(programPath, new Set([].concat(Array.from(imported.keys()), Array.from(exported.keys()))));
...
var importThrow = (0, _babelTemplate.default)("\n  (function() {\n    throw new Error('\"' + NAME + '\" is read-only.');\n  })();\n");
