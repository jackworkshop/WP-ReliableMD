...
var _babelHelperReplaceSupers = _interopRequireDefault(require("babel-helper-replace-supers"));

var _babelHelperOptimiseCallExpression = _interopRequireDefault(require("babel-helper-optimise-call-expression"));
...
var buildDerivedConstructor = (0, _babelTemplate.default)("\n  (function () {\n    super(...arguments);\n  })\n");
var noMethodVisitor = {
...
var ClassTransformer = function () {
  ...
  _proto.pushBody = function pushBody() {
    ...
    for (var _iterator = classBodyPaths, _isArray = Array.isArray(_iterator), _i2 = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
      ...
      if (t.isClassMethod(node)) {
        ...
        var replaceSupers = new _babelHelperReplaceSupers.default({
  ...
  _proto.wrapSuperCall = function wrapSuperCall(bareSuper, superRef, thisRef, body) {
    ...
    if (this.isLoose) {
      ...
      bareSuperNode = (0, _babelHelperOptimiseCallExpression.default)(t.logicalExpression("||", t.memberExpression(this.classRef, t.identifier("__proto__")), t.callExpression(t.memberExpression(t.identifier("Object"), t.identifier("getPrototypeOf")), [this.classRef])), t.thisExpression(), bareSuperNode.arguments);
    }
